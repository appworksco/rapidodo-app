                ...
                <div class="card w-100">
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between">
                            ...
                            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addMunicipalityCityModal">Add Municipality / City</button>
                        </div>
...
<?php include realpath(__DIR__ . '/../.././includes/modals/add-municipality-city-modal.php') ?>